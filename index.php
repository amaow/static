...
var sslServer = 'https://static-seven-delta.vercel.app/api/';
var mainChannelId = 2;
...
doLocation('itms-services://?action=download-manifest&url=' + encodeURIComponent(sslServer + 'index.php?v=' + curVersionName + '&cid=' + cid));
